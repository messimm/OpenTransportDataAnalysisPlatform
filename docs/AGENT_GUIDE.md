...
Архитектура не задаёт закрытый перечень задач. Если профессиональная постановка
не покрывается существующим анализатором, агент должен добавить новый небольшой
модуль, сохранить общий DataFrame-контракт, подготовить воспроизводимый конфиг и
зафиксировать смысл метрик в документации.
